...
- Etapa 1
    ...
    Efetuar processo de Pré-Processamento dos Dados, documentando cada passo no 
    Google Colab. Incluir Justificativa do Projeto e Resumo Estatístico dos Dados. A base 
    escolhida não poderá estar com esta etapa previamente resolvida ou ser cópia de 
